...
본 프로젝트를 통해 IT 채용 시장에서 **Python과 AI 기술의 트렌드화**를 데이터로 확인. 취업을 위해서는 단순히 코딩 실력뿐만 아니라 **AWS/Docker/Git을 활용한 개발 환경 구축 능력**, 그리고 팀원과 원활하게 소통하고 협업하는 태도**를 갖추는 것이 핵심임을 알 수 있었음.
